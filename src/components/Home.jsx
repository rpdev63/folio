...
function Home(){
  return (
    <div name='home' className='w-full   h-screen bg-[#f2f7f2]'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full text-gray-800 '>
      <p style={{fontSize :  20 }}>Bonjour, je suis </p>
        ...
        <div className=' sm:flex items-center'>
            ...
            <a className='sm:ml-4 border-2 border-[#C17767]  text-[#C17767] px-4 py-3  rounded-sm hover:bg-[#433a3f] hover:text-white duration-200 hover:border-[#433a3f] font-bold text-sm' href=''> Voir mon CV </a>
        </div>
        <div>
            <a  className='mt-5 sm:mt-0 cursor-pointer group flex items-center hover:decoration-text-[#C17767] underline w-min' > <Link to='skills' smooth={true} duration={500}>Poursuivre... </Link> .  
